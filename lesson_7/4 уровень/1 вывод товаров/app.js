...
let productsAll = document.querySelectorAll('.products');
let button = document.querySelectorAll('button');
let div = document.querySelector('div');
button.forEach(elem => elem.addEventListener('click', clickHandler))
/**
...
function showCategory(category) {
    ...
    categories.forEach(product => {
        show += getProductMarkup(product);
    });
    div.innerHTML = '';
    div.insertAdjacentHTML('afterbegin', show);
}
